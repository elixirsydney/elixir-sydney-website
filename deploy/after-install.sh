...
aws --region=ap-southeast-2 s3 cp s3://sydney-elixir/prod_database.secret.exs /opt/elixir-sydney/codedeploy/config/prod_database.secret.exs
...
# FIXME: don't run the seeds on every installation?
